...
short="Dr. Khanh Nguyen is a longevity and regenerative medicine expert, founder of Austin Regenerative Therapy, and SSRP Fellow. She helps audiences look beyond symptoms to understand what drives cellular decline - and how foundational health, responsible innovation, and the right therapeutic sequence can help people function better for longer."
medium="Dr. Khanh Nguyen is a longevity and regenerative medicine expert with more than 20 years of hospital-based critical care experience. After navigating her own autoimmune illness and caring for a son with a rare neurological condition, she shifted from asking only what the diagnosis was to asking what caused the cell to struggle in the first place. As founder of Austin Regenerative Therapy, she begins with the individual's biology and foundational health, then thoughtfully sequences therapies ranging from hormone optimization and peptides to plasma exchange and cellular medicine. Dr. Nguyen is an SSRP Fellow, educator, and sought-after voice on the science, ethics, and future of living better for longer."
rect(TEAL,45,360,220,265); eyebrow("01  Short bio",63,598,colors.white); para(short,63,570,184,185,9.8,15.7,"Serif",colors.white); rect(colors.white,277,360,290,265); eyebrow("02  Medium bio",295,598); para(medium,295,570,254,190,9.2,14.8,"Serif",INK)
eyebrow("03  Full biography",45,326); full=["Dr. Khanh Nguyen is a physician, longevity and regenerative medicine expert, educator, and founder of Austin Regenerative Therapy. With more than 20 years in hospital-based critical care, she brings the rigor of acute medicine to one of health care's fastest-moving fields.","Her path into regenerative medicine is deeply personal. After overcoming an autoimmune illness and caring for a son with a rare neurological condition, Dr. Nguyen became what she calls patient number one. She began looking beyond crisis-driven care and asking what caused the cell to struggle in the first place. Today, she starts with each person's biology, history, goals, and foundational health before determining which therapies belong in the plan - and in what sequence.","Born in Vietnam, Dr. Nguyen escaped the country by boat at 13 and rebuilt her life in the United States. She earned her medical degree from Rush Medical College and completed fellowship training in critical care. She is board-certified in internal medicine, an SSRP Fellow and faculty member, and an ISSCA educator."]
...
topics=[("What Makes the Cell Fail?","The question that moved Dr. Nguyen from crisis medicine to root-cause cellular care."),("Plasma Exchange & Healthspan","Evidence, treatment approaches, and the questions responsible patients should ask."),("Peptides & Personalized Medicine","Biomarkers, pathways, goals, and a precise approach to peptide therapy."),("The Right Therapy, in the Right Sequence","Why biology, foundational health, and goals must come before the product."),("Hormones, Women & Longevity","Energy, sexual health, cognition, and hormonal change across every decade."),("From Burnout to Reinvention","Rebuilding work, health, and identity when success is no longer sustainable.")]
